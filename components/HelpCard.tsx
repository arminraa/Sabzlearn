export default function HelpCard({
  ...
  return (
    <article className="w-full lg:h-[140px] rounded-xl p-5 overflow-y-hidden bg-white">
      <div className="flexCenter flex-col lg:flex-row gap-4">
        ...
        <div className="lg:min-w-[75px] lg:max-w-[90px]">
          ...
          >
            <i
              className={`absolute ${icon} text-4xl text-${color} -bottom-5 lg:top-1/2 lg:bottom-0 lg:-left-5 left-1/2 -translate-x-1/2 lg:translate-x-0 lg:-translate-y-1/2`}
            ></i>
          </span>
        </div>
        ...
        <div className="flexCenter text-center lg:text-start lg:items-start flex-col gap-1">
          <h3 className="font-bold lg:text-lg">تضمین کاملترین محتوا</h3>
          <p className="text-sm lg:text-[1rem] leading-7 text-superLightGray">
